            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  <span className="orange-color fs-5 me-2">Description:</span>
                  {discription}
                </p>
                ...
                <p className="card-text fw-bold">
                  <span className="orange-color me-1">Supplier:</span>{" "}
                  {supplierName}
                </p>
                <h4>
                  <span className="orange-color me-1">Price:</span> ${price}
                </h4>
                <h4>
                  <span className="orange-color me-1">Quantity:</span>{" "}
                  {quantity}
                </h4>
                <button onClick={handleDedeverd} className="button">
                  Deleverd
                </button>
                <div className="d-flex">
                  ...
                  >
                    <input
                      className="mb-1 input mt-3"
                      placeholder="Add Items Quantity"
                      type="number"
                ...
                <div>
                  <Link to={"/manageInventory"}>
                    {" "}
                    <button className="button">All Inventory</button>{" "}
                  </Link>
                </div>
              </div>
            </div>
