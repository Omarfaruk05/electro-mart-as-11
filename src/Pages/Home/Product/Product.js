...
const Product = ({ product }) => {
  ...
  const { _id, name, img, discription, price, supplierName, quantity } =
    product;
  if (name.length > 20) {
    ...
    <div className=" col-md-6 col-lg-4">
      <Card className="product-card m-4">
        ...
        <Card.Body>
          ...
          <Card.Text>{discription.slice(0, 120) + "......."}</Card.Text>
          <h5>
            Supplier: <span>{supplierName.slice(0, 8)}..</span>
          </h5>
          <h5>
          ...
          <button
            ...
            className="update-btn mt-3 text-center w-100"
          >
            Update
          </button>
        </Card.Body>
